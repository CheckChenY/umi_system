...
-- ----------------------------
-- Table structure for menu_chilren
-- ----------------------------
DROP TABLE IF EXISTS `menu_chilren`;
CREATE TABLE `menu_chilren`  (
...
-- ----------------------------
-- Records of menu_chilren
-- ----------------------------
INSERT INTO `menu_chilren` VALUES (0, '2', 1, '分析页', 'user', '/index/action');
INSERT INTO `menu_chilren` VALUES (1, '3', 1, '监控页', 'user', '/index/monitor');
INSERT INTO `menu_chilren` VALUES (2, '4', 1, '工作台', 'user', '/index/analysis');
...
CREATE TABLE `menu_list`  (
  ...
  `key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `router` varchar(1600) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `icon` varchar(1600) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `menu_list` VALUES (0, '0', '主页', '/', 'user');
INSERT INTO `menu_list` VALUES (1, '1', '操作', '/1', 'user');
...
CREATE TABLE `new_table`  (
  `id` int(0) NOT NULL,
  `new_tablecol` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `new_tablecol1` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_config`  (
  ...
  `set_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
...
-- ----------------------------
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables', 'OFF', '2020-12-28 16:30:50', NULL);
INSERT INTO `sys_config` VALUES ('diagnostics.include_raw', 'OFF', '2020-12-28 16:30:50', NULL);
INSERT INTO `sys_config` VALUES ('ps_thread_trx_info.max_length', '65535', '2020-12-28 16:30:50', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.limit', '100', '2020-12-28 16:30:50', NULL);
INSERT INTO `sys_config` VALUES ('statement_performance_analyzer.view', NULL, '2020-12-28 16:30:50', NULL);
INSERT INTO `sys_config` VALUES ('statement_truncate_len', '64', '2020-12-28 16:30:50', NULL);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (2, '陈亚力', '18', 'admin', 'admin');
INSERT INTO `user` VALUES (10, 'user', '10', 'user', 'user');
...
INSERT INTO `websites` VALUES (5, '首页数据', 'https://www.facebook.com/', 3, 'USA');
INSERT INTO `websites` VALUES (6, '菜鸟移动站', 'http://baidu.com', 23453, 'CN');
INSERT INTO `websites` VALUES (7, '菜鸟工具', 'https://c.runoob.com.com', 23453, 'CN');
INSERT INTO `websites` VALUES (13, '陈亚力', 'ewew', 1, 'CN');
INSERT INTO `websites` VALUES (14, '44', 'ewew', 999999, 'CN');
INSERT INTO `websites` VALUES (15, '', '', 0, '');
INSERT INTO `websites` VALUES (16, '', '', 0, '');
INSERT INTO `websites` VALUES (17, '', '', 0, '');
INSERT INTO `websites` VALUES (18, '', '', 0, '');
INSERT INTO `websites` VALUES (19, '', '', 0, '');
INSERT INTO `websites` VALUES (20, '', '', 0, '');
INSERT INTO `websites` VALUES (21, '', '', 0, '');
INSERT INTO `websites` VALUES (22, '', '', 0, '');
INSERT INTO `websites` VALUES (23, '', '', 0, '');
INSERT INTO `websites` VALUES (24, '', '', 0, '');
INSERT INTO `websites` VALUES (25, '', '', 0, '');
INSERT INTO `websites` VALUES (26, '', '', 0, '');
INSERT INTO `websites` VALUES (27, '', '', 0, '');
INSERT INTO `websites` VALUES (28, '', '', 0, '');
INSERT INTO `websites` VALUES (29, '', '', 0, '');
...
CREATE ALGORITHM = UNDEFINED DEFINER = `mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `version` AS select '2.1.1' AS `sys_version`,version() AS `mysql_version`;
